...
- [ ] **`VERIFY`** `01_objects/expansion.md` — **Complete expansion parameters list + defaults:** Schema currently includes `active_only` (default true) and `repo_versions`. Confirm these are accurate and complete against oclapi2 implementation. Additional parameters (if any) can be added post-V3 via tbv3-deferred-features.md.
...
| Validation rule configurability (v3 scope) | `validate-content.md`, `tbv3-deferred-features.md` | Not in scope for v3; deferred |
| Validation Report Panel for Sources | `validate-content.md`, `tbv3-deferred-features.md` | Queued as TBv3 dedicated topic |
...
| $match operation for proposers | `tbv3-deferred-features.md` | Deferred post-v3 |
| Group similar proposals for admins | `tbv3-deferred-features.md` | Deferred post-v3 |
| Post-approval actions for proposer | `tbv3-deferred-features.md` | Deferred post-v3 |
| Public-facing proposal view | `tbv3-deferred-features.md` | Deferred post-v3 |
| Transform to update pinned version | `tbv3-deferred-features.md` | Deferred post-v3 |
| Dropdown config linked to OCL source | `tbv3-deferred-features.md` | Deferred post-v3 |
| Extra attribute template configuration | `tbv3-deferred-features.md` | Deferred post-v3 |
| Repository Subtypes (ConceptMap, CodeSystem) | `tbv3-deferred-features.md` | Deferred post-v3 |

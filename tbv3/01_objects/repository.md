...
> **Post-v3:** Whether ConceptMap belongs as a Source subtype, a Collection subtype, or both — and whether CodeSystem deserves a top-level repo type distinct from Source/Collection — are deferred to post-v3. The table below reflects the current v3 model. See `tbv3-deferred-features.md`.
